...
plotArcNum <- function(data_size_vec, tp_vec, fp_vec, fn_vec, try_size){
  plot(data_size_vec, tp_vec, xlim=c(0, max(data_size_vec)) , ylim=c(0, max(c(tp_vec, fp_vec, fn_vec))) ,col="blue", type="b", xlab="", ylab="")
  par(new=T)
  plot(data_size_vec, fp_vec, xlim=c(0, max(data_size_vec)) , ylim=c(0, max(c(tp_vec, fp_vec, fn_vec))) ,col="red", type="b", xlab="", ylab="")
  par(new=T)
  plot(data_size_vec, fn_vec, xlim=c(0, max(data_size_vec)) , ylim=c(0, max(c(tp_vec, fp_vec, fn_vec))) ,col="black", type="b", xlab="vector num", ylab="data size")
  par(new=T)
